...
class AdminC{
    function addAdmin($newAdmin){
        ...
        try {
            ...
            $query = $db->prepare(
                'INSERT INTO admin (username,email,image,password) 
    ...
    function updateAdminUsername($newName,$adminId){
    ...
    function updateAdminEmail($newEmail,$adminId){
    ...
    function updateAdminImage($newImage,$adminId){
    ...
    function updateAdminPassword($newPassword,$adminId){
        $db = config::getConnexion();
        try{
            $query = $db->prepare(
