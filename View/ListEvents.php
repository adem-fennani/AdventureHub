...
<html>
<head>
<title>News and Tips - Frontoffice</title>
<meta charset="UTF-8">
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container">
    <h5>Les événement les plus visités</h5>
    <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-white">
      <tr>
        <td>Holi (Colour Festival)
        </td>
        <td>250</td>
      </tr>
      <tr>
        <td>The Real Mary King's Close</td>
        <td>200</td>
      </tr>
      <tr>
        <td>Blue Grotto Boat Tour</td>
        <td>182</td>
      </tr>
      <tr>
        <td> Seoul Tour</td>
    ...
    <button class="w3-button w3-dark-grey"> plus d'événement  <i class="fa fa-arrow-right"></i></button>
  </div>
  <hr>
  <div class="w3-container">
    ...
    <ul class="w3-ul w3-card-4 w3-white">
      <li class="w3-padding-16">
        <img src="img/mike.jpg" class="w3-left w3-circle w3-margin-right" style="width:35px">
      ...
      <li class="w3-padding-16">
        <img src="img/jane.jpg" class="w3-left w3-circle w3-margin-right" style="width:35px">
