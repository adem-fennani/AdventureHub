...
<body>
    ...
    <td>
        <input type="text" name="post_id" id="post_id" maxlength="20" value="<?= isset($_POST["id"]) ? $_POST["id"] : "" ?>" readonly>
    </td>
    <td>
    </td>
</tr>
            ...
            <tr>
                ...
                <td><textarea id="comment" name="comment" rows="10" cols="50"  style="     width: 100%; /* Adjusts to the length of the page */
      padding: 10px;
