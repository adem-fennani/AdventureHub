...
<tr>
  ...
  <td> <span id="erreurHost" style='color:red' ></span></td>
      ...
      <br><br>
<tr>
  <textarea placeholder="description" id="description" name="description" rows="10" cols="50" maxlength=1000 required
...
<tr>
  <input class="w3-input w3-section w3-border" type="text" placeholder="location"  name="location" id="location" required maxlength=20>
  <td> <span id="erreurLocation" style='color:red' ></span></td>
</tr>
<tr>

  <input class="w3-input w3-section w3-border" type="date" placeholder="date"  name="date" id="date" required>
  <td> <span id="erreurDate" style='color:red' ></span></td>
</tr>
<tr>
  <input class="w3-input w3-section w3-border" type="text" placeholder="status"  name="status" id="status" required maxlength=20>
  <td> <span id="erreurStatus" style='color:red' ></span></td>
</tr>
