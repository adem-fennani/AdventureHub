  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      ...
      <form action="" method="post">
        <input class="w3-input w3-section w3-border" type="text" placeholder="id event" required name="ide" id="ide">
        <input class="w3-input w3-section w3-border" type="text" placeholder="id user" required name="idu" id="idu">
        <textarea placeholder="contenu" id="contenu" name="contenu" rows="10" cols="50" required></textarea>
        <input class="w3-input w3-section w3-border" type="date" placeholder="publicationDate" required name="publicationDate" id="publicationDate">
